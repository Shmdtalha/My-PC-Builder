...
public class ComputerBuild {
    ...
    public static List<Component> storages;
    public static List<Component> motherboards;
    public static List<Component> gpus;
    public static List<Component> coolers;
    public static List<Component> buildCases;
    static {
        ...
        buildCases = new ArrayList<>();

        components.add(cpus);
        components.add(rams);
        components.add(psus);
        components.add(motherboards);
        components.add(storages);
        components.add(gpus);
        components.add(coolers);
        components.add(buildCases);
